...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/570bc1bf-234d-4b59-802d-6d4393327291";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/945D-0CD2";
      fsType = "vfat";
      options = [ "fmask=0077" "dmask=0077" ];
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/47dc72dc-fe9f-4caf-a327-94f909062410"; }
    ];
